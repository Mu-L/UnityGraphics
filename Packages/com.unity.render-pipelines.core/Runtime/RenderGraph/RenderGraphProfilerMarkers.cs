...
namespace UnityEngine.Rendering.RenderGraphModule
{
    ...
    internal static class RenderGraphProfilerMarkers
    {
        ...
        /// </summary>
        public static readonly ProfilingSampler CompileRenderGraph = ProfilingSampler.Create(nameof(CompileRenderGraph), MarkerFlags.Default);
        ...
        /// </summary>
        public static readonly ProfilingSampler ComputeHashRenderGraph = ProfilingSampler.Create(nameof(ComputeHashRenderGraph), MarkerFlags.VerbosityAdvanced);
    }
}
