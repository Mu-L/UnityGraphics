namespace UnityEngine.Rendering.HighDefinition
{
    ...
    {
        public static readonly Vector3Int s_ClusterSize = new Vector3Int(64, 32, 64);
        public static readonly int s_ClusterCellCount = s_ClusterSize.x * s_ClusterSize.y * s_ClusterSize.z;

        public static readonly int s_CellMetaDataSize = 5;
    }
